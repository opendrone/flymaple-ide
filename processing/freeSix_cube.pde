...
final String serialPort = "/dev/ttyACM0";  // change this to your port on linux. Should be something like "/dev/ttyACM0"
//final String serialPort = "COM1"; // replace this with your serial port. On windows you will need something like "COM1".
